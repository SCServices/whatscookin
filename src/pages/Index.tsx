...
const Index = () => {
  return (
    <div className="min-h-screen bg-white text-black">
      {/* Header */}
      <header className="w-full p-4 sm:p-6 bg-white shadow-sm animate-fade-in">
      ...
      {/* Main Content */}
      <main className="container max-w-6xl mx-auto p-4 sm:p-6 md:p-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
